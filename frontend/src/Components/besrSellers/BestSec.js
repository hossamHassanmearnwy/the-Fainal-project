    ...
    return (
            ...
            <Nav variant="pills" className="flex-column justify-content-end align-items-end" activeKey={activeTab} onSelect={handleTabClick}>
                <Nav.Item >
                    ...
                    style={{ border: activeTab === 'first' ? '1px solid #ffc107' : '', background: activeTab === 'first' ? 'none' : '' , outline: activeTab === 'first' ? 'none' : '' }}>{t('Top 10')}</Nav.Link>
                </Nav.Item>
                <Nav.Item className='outline-none'>
                    ...
                    style={{ border: activeTab === 'second' ? '1px solid #ffc107' : '', background: activeTab === 'second' ? 'none' : '', outline: activeTab === 'second' ? 'none' : '' }}>{t('Mobiles & Tablets')}</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link eventKey="third" className='bg-none border-none rounded-pill text-warning px-1 text-decoration-none' 
                    style={{ border: activeTab === 'third' ? '1px solid #ffc107' : '', background: activeTab === 'third' ? 'none' : '', outline: activeTab === 'third' ? 'none' : ''  }}>{t('Computers & Labtops')}</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link eventKey="fourth" className='bg-none border-none rounded-pill text-warning px-1 text-decoration-none'
                    style={{ border: activeTab === 'fourth' ? '1px solid #ffc107' : '', background: activeTab === 'fourth' ? 'none' : '' , outline: activeTab === 'fourth' ? 'none' : '' }}>{t('Power Supply')}</Nav.Link>
                </Nav.Item>
            </Nav>
            </Row>
